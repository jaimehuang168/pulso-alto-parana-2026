...
function docker(args){try{return execFileSync('docker',['exec',container,...args],{encoding:'utf8',stdio:['ignore','pipe','pipe'],timeout:90000});}catch(e){throw new Error('Local backup/restore command failed: '+args[0]+' (exit '+e.status+')');}}
